...
% GUI_MAXDENSITY MATLAB code for GUI_MaxDensity.fig
...
%
%      GUI_MAXDENSITY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_MAXDENSITY.M with the given input arguments.
%
%      GUI_MAXDENSITY('Property','Value',...) creates a new GUI_MAXDENSITY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_MaxDensity_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_MaxDensity_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 04-Dec-2015 14:40:53
...
% varargin   command line arguments to GUI_MaxDensity (see VARARGIN)
